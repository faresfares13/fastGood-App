...
public class SlowCooker extends Fragment {
    GridView gridview;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.fragment_slow_cooker, container, false);
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        databaseAccess.open();
         ...
         gridview.setAdapter(new CustomAdapter(this.getActivity(),
                 databaseAccess.getSCRecipeName(),
                 databaseAccess.getSCImages()));
